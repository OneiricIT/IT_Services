var signature={
	...
	make: function() {
		...
		$('div[data-fieldname="signature"]')[$('div[data-fieldname="signature"]').length-1].innerHTML=`<div class="clearfix">						<label class="control-label" style="padding-right: 0px;">Signature</label>					</div><br>`
		this.body = $('<div class="signature-field"></div>').appendTo($('div[data-fieldname="signature"]')[$('div[data-fieldname="signature"]').length-1]);
		this.make_pad();
